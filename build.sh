...
git clone https://github.com/thedoctorsz/local_manifest --depth 1 -b rising-13 .repo/local_manifests
...
mka lineage -j8 > reading & sleep 95m # Jangan di hapus text line (> reading)
