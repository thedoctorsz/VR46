...
git clone https://github.com/thedoctorsz/local_manifest --depth 1 -b derp-13 .repo/local_manifests
...
mka derp -j8 > reading #& sleep 95m # Jangan di hapus text line (> reading)
