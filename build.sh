...
git clone https://github.com/thedoctorsz/local_manifest --depth 1 -b superior-13 .repo/local_manifests
...
m bacon -j32 > reading #& sleep 95m # Jangan di hapus text line (> reading)
